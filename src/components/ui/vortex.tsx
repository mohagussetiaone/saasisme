...
export const Vortex = (props: VortexProps) => {
  ...
  const drawParticle = (x: number, y: number, x2: number, y2: number, life: number, ttl: number, radius: number, _hue: number, ctx: CanvasRenderingContext2D) => {
    ctx.save();
    ctx.lineCap = "round";
    ...
    gradient.addColorStop(0, `rgba(16,21,51,${alpha})`); // #101533
    gradient.addColorStop(1, `rgba(33,133,198,${alpha})`); // #2185c6
