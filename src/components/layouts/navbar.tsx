    ...
    <nav className="sticky top-0 bg-white w-full z-50 transition-all duration-300">
      ...
      <div className={`md:hidden p-2 bg-white absolute top-full left-0 w-full shadow-lg transition-all duration-300 ${isMenuOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0 overflow-hidden"}`}>
        <div className="container mx-auto py-4 flex flex-col space-y-4">
          <a href="#services" className="hover:text-blue-600 transition-colors py-2" onClick={closeMenu}>
            Layanan
          </a>
          <a href="#features" className="hover:text-blue-600 transition-colors py-2" onClick={closeMenu}>
            Keunggulan
          </a>
          <a href="#portfolio" className="hover:text-blue-600 transition-colors py-2" onClick={closeMenu}>
            Portfolio
          </a>
          <a href="#about" className="hover:text-blue-600 transition-colors py-2" onClick={closeMenu}>
            Tentang Kami
          </a>
