    ...
    <section id="about" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Tentang PT SAAS</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-2xl font-bold mb-4">Siapa Kami?</h3>
            <p className="text-gray-600 mb-4">
              PT Solusi Aplikasi Andalan Semesta (SAAS) adalah perusahaan pengembang solusi software terkemuka yang merupakan bagian dari PT Remala Abadi Tbk (Remala Group). Sebagai anak perusahaan dari salah satu penyedia layanan internet
              terbesar di Indonesia, kami menghadirkan solusi teknologi yang inovatif dan terintegrasi untuk berbagai kebutuhan bisnis.
            </p>
            <p className="text-gray-600 mb-4">
              Dengan pengalaman lebih dari 10 tahun di industri teknologi, kami telah membantu ratusan perusahaan dalam melakukan transformasi digital melalui solusi software yang handal, aman, dan scalable.
            </p>
          ...
          <div className="relative">
            ...
            <div className="absolute h-[200px] -bottom-3 -right-3 z-0 bg-blue-600 text-white p-6 rounded-xl shadow-lg max-w-xs">
              <p className="font-bold">100+ Project Selesai</p>
